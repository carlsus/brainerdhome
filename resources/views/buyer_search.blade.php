    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="/buyers" class="nav-link">Purchase a Home</a></li>
            </ul>
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link btn login" href="../assets/login.html">Login</a>
                </li>
            </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="text-center">
                        <a href="/buyers/register">Register</a> to avail of our exclusive deals.
                    </div>
                </div>    
            </div>
        </div>
...
<footer class="ftco-footer">
    ...
    <div class="row mb-5">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3">
            ...
            <li><a href="/buyers"><span class="fa fa-chevron-right mr-2"></span>Purchase a Home</a></li>
            </ul>
        </div>
        </div>
...
<script>
    ...
    window.onload = function () {
        ...
        stateSel.onchange = function () {
            ...
            var cities = stateObject[stateSel.value];
            console.log(cities);
